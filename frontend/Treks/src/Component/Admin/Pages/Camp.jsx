  ...
  return (
    <>
      <div className='w-full h-[120px] bg-black text-white'>
        <h1 className='text-5xl pt-8 pl-5 flex p-1'> <span className='mr-4'>Camp</span>  <GiCampingTent/></h1>
      </div>
      <div className='flex flex-col bg-slate-100 h-fit justify-between'>
          ...
          <div className='flex flex-col h-fit' >
            <div className='flex flex-row bg-white rounded-lg h-[50%] m-6'>
              <div className='h-[15%] rounded-lg m-3 '>
                <img src="/Images/camp1.jpg" className="rounded-lg" width={200} height={300} alt="" />
              </div>
        ...
        <div className='flex items-center justify-center m-3'>
          <div>
          <Link to={"/admin/dashboard/addtrek/camp"}>
